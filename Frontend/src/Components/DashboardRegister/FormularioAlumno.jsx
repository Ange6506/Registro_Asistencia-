    ...
    <div className="bg-white p-8 rounded-lg shadow-xlmx-auto  w-full mx-auto">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            <label htmlFor="nombre_del_estudiante" className="block text-sm font-medium text-gray-700">
              Nombre del Estudiante
            </label>
            <input
              type="text"
       ...
       {/* Programa */}
          ...
          <div>
            <label htmlFor="fecha_terminacion" className="block text-sm font-medium text-gray-700">
              Fecha de Terminación
            </label>
            <input
              type="date"
          ...
          {/* Días de la Semana */}
          <div>
            <label htmlFor="dias_semana" className="block text-sm font-medium text-gray-700">
              Días de la Semana
            </label>
            <input
              type="text"
          ...
          {/* Horas por Día */}
          <div>
            <label htmlFor="horas_por_dia" className="block text-sm font-medium text-gray-700">
              Horas por Día
            </label>
            <input
              type="number"
          ...
          {/* Semanas de Rotación */}
          <div>
            <label htmlFor="semanas_de_rotacion" className="block text-sm font-medium text-gray-700">
              Semanas de Rotación
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="numero_horas_semanales" className="block text-sm font-medium text-gray-700">
              Número de Horas Semanales
            </label>
            <input
              type="number"
          ...
          {/* Semestre Académico */}
          <div>
            <label htmlFor="semestre_academico" className="block text-sm font-medium text-gray-700">
              Semestre Académico
            </label>
            <input
              type="text"
