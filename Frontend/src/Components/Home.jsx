...
const Home = () => {
 ...
 Este sistema de software libre está diseñado específicamente para la Universidad en la Clínica Nueva Rafael Uribe Uribe, ofreciendo seguridad y facilidad en el control de asistencia.
          </p>
          <div>
  ...
  <img src={tailwind} className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto" alt="Tailwind Logo" />
  <img src={react} className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto" alt="React Logo" />
  <img src={coty} className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto" alt="Coty Logo" />
  <img src={nodejs} className="h-6 sm:h-8 md:h-10 lg:h-12 w-auto" alt="Node.js Logo" />
</div>
