...
const Login = () => {
  return (
    <>
     <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg transition-transform transform mx-auto max-w-lg border border-gray-200">
