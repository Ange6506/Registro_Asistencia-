            ...
            <div className="mt-2 pl-6 space-y-2">
              <li>
                <SidebarButton
                  ...
                  text={<span className="text-sm">Huellero</span>}
                />
              </li>
            </div>
          )}
            ...
            <div className="mt-2 pl-6 space-y-2">
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Creación Alumnos</span>
                  }
                />
              </li>
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Creación Programas</span>
                  }
                />
              </li>
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Creación Asistencia</span>
                  }
                />
              </li>
              <li>
