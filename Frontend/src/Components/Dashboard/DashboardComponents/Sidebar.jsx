            ...
            <div className="mt-2 pl-6 space-y-2">
              ...
              <li>
                <SidebarButton
                  ...
                  text={<span className="text-sm">Creación de usuario</span>}
                />
              </li>
              <li>
                <SidebarButton
                  ...
                  text={<span className="text-sm">Usuarios del sistema</span>}
                />
              </li>
            </div>
          )}
            ...
            <div className="mt-2 pl-6 space-y-2">
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Registro de estudiantes</span>
                  }
                />
              </li>
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Registro de Programas </span>
                  }
                />
              </li>
              <li>
                <SidebarButton
                  ...
                  text={
                    <span className="text-sm">Registro de Asistencia </span>
                  }
                />
              </li>
            </div>
